...
namespace aakashPawar.Models
{
    public class OAuthBase
    {
        ...
        ///     The callback URL (for OAuth 1.0a).If your client cannot accept callbacks, the value MUST be
        ///     'oob'
        /// </param>
        /// <param name="oauthVerifier">
        ///     This value MUST be included when exchanging Request Tokens for Access Tokens. Otherwise
        ///     pass a null or an empty string
        /// </param>
